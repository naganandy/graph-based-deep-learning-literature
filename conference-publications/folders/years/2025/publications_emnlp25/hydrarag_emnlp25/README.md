...
```
@inproceedings{hydrarag_emnlp25,
title = {{H}ydra{RAG}: Structured Cross-Source Enhanced Large Language Model Reasoning},
...
links
- [acl](https://aclanthology.org/2025.emnlp-main.730/)
